...
#define Enable_GPIOC_CLOCK_GATING()		Rcc->Ahb1enr |= (1<<2)
#define Enable_GPIOD_CLOCK_GATING()		Rcc->Ahb1enr |= (1<<3)
#define Enable_GPIOG_CLOCK_GATING()		Rcc->Ahb1enr |= (1<<6)

#define Disable_DMA1_CLK_GATING()		Rcc->Ahb1enr &= ~(1<<21)
#define Disable_DMA2_CLK_GATING()		Rcc->Ahb1enr &= ~(1<<21)
...
#define Unreset_UART2()					Rcc->Apb1rstr &= ~(1<<17)
#define Unreset_UART3()					Rcc->Apb1rstr &= ~(1<<18)
#define Unreset_UART4()					Rcc->Apb1rstr &= ~(1<<19)
#define Unreset_UART5()					Rcc->Apb1rstr &= ~(1<<20)
